...
class TestAutomotiveTemplates:
    ...
    async def test_get_templates(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get(
            "/api/v1/automotive/templates", headers=auth_headers
        )
    ...
    async def test_get_template_by_id(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get(
            f"/api/v1/automotive/templates/{template_id}", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    async def test_filter_templates_by_category(
        ...
        response = await client.get(
            "/api/v1/automotive/templates?category=service", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    async def test_filter_templates_by_specialization(
        self, client: AsyncClient, auth_headers: dict
    ):
        """Test filtering templates by specialization"""
        response = await client.get(
            "/api/v1/automotive/templates?specialization=sales_assistant",
            headers=auth_headers,
        )
        assert response.status_code == 200
...
class TestAutomotiveDatasets:
    ...
    async def test_get_dataset_by_id(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get(
            f"/api/v1/automotive/datasets/{dataset_id}", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    async def test_filter_datasets_by_category(
        self, client: AsyncClient, auth_headers: dict
    ):
        """Test filtering datasets by category"""
        response = await client.get(
            "/api/v1/automotive/datasets?category=service", headers=auth_headers
        )
        assert response.status_code == 200
...
class TestTrainingPipeline:
    ...
    async def test_start_training_pipeline(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    async def test_get_training_status(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get(
            f"/api/v1/automotive/training/{job_id}/status", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    async def test_cancel_training(self, client: AsyncClient, auth_headers: dict):
        ...
        # Cancel the job
        response = await client.post(
            f"/api/v1/automotive/training/{job_id}/cancel", headers=auth_headers
        )
        assert response.status_code == 200
...
class TestSpecializationInfo:
    ...
    async def test_get_specializations(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get(
            "/api/v1/automotive/info/specializations", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    async def test_get_categories(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get(
            "/api/v1/automotive/info/categories", headers=auth_headers
        )
        assert response.status_code == 200
...
class TestTemplateService:
    ...
    async def test_template_service_initialization(
        self, template_service: AutomotiveTemplateService
    ):
...
class TestTrainingService:
    ...
    async def test_training_service_initialization(
    ...
    async def test_cancel_non_existent_training(
        self, training_service: TrainingPipelineService
    ):
...
class TestFullWorkflow:
    ...
    async def test_complete_workflow(self, client: AsyncClient, auth_headers: dict):
        ...
        datasets_response = await client.get(
            "/api/v1/automotive/datasets", headers=auth_headers
        )
        ...
        service_template = next(
            (t for t in templates if t["specialization"] == "service_advisor"), None
        )
        assert service_template is not None

        instantiation_request = {
            "template_id": service_template["id"],
            "inputs": service_template["example_inputs"][0]
            if service_template["example_inputs"]
            else {},
        }
        ...
        service_dataset = next(
            (d for d in datasets if "service" in d["specializations"]), None
        )
