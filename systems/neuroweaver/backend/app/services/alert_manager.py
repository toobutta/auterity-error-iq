...
class Alert:
    def __init__(self, alert_type: AlertType, severity: AlertSeverity, 
                 model_id: str, message: str, metadata: Dict = None):
...
class AlertManager:
    ...
    async def create_alert(self, alert_type: AlertType, severity: AlertSeverity,
                          model_id: str, message: str, metadata: Dict = None) -> Alert:
    ...
    def _is_duplicate_alert(self, new_alert: Alert) -> bool:
        ...
        for alert in self.active_alerts:
            if (not alert.resolved and 
                ...
                alert.model_id == new_alert.model_id and
    ...
    async def _send_console_alert(self, alert: Alert):
        ...
        log_func(f"ALERT [{alert.severity.value.upper()}] {alert.alert_type.value}: "
