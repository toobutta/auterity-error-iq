...
interface CostPredictionModel {
  ...
  optimizeModelSelection(request: AIRequest, budget: Budget): Promise<ModelSelection>
...
interface PerformanceMonitor {
  ...
  optimizeAutomatically(trigger: OptimizationTrigger): Promise<OptimizationResult>
}
