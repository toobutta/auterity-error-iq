        ...
        "definition": {
            "nodes": [
                ...
                },
                {
                    "id": "extract",
                    "type": "ai_process",
                    "data": {"prompt": "Extract service details: {{service_request}}"},
                },
            ],
            "edges": [{"source": "start", "target": "extract"}],
        },
        "parameters": [
            {"name": "service_request", "parameter_type": "string", "is_required": True}
        ],
    }
        ...
        "definition": {
            "nodes": [
                ...
                },
                {
                    "id": "identify",
                    "type": "ai_process",
                    "data": {"prompt": "Identify part from request: {{parts_request}}"},
                },
            ],
            "edges": [{"source": "start", "target": "identify"}],
        },
        "parameters": [
            {"name": "parts_request", "parameter_type": "string", "is_required": True}
        ],
    }
