...
class TestTemplateEngine:
    ...
    async def test_create_template(self, template_engine: TemplateEngine, sample_template_data):
    ...
    async def test_get_templates(self, template_engine: TemplateEngine, sample_template_data):
    ...
    async def test_get_template_by_id(self, template_engine: TemplateEngine, sample_template_data):
    ...
    async def test_instantiate_template(self, template_engine: TemplateEngine, sample_template_data, test_user: User):
    ...
    async def test_instantiate_template_with_defaults(self, template_engine: TemplateEngine, sample_template_data, test_user: User):
    ...
    async def test_instantiate_template_validation_errors(self, template_engine: TemplateEngine, sample_template_data, test_user: User):
        ...
        with pytest.raises(ValueError, match="Required parameter 'input_text' is missing"):
    ...
    async def test_parameter_type_validation(self, template_engine: TemplateEngine):
        ...
        assert template_engine._validate_parameter_type(param, "not a number") is not None
        ...
        assert template_engine._validate_parameter_type(param, "not an array") is not None
        ...
        assert template_engine._validate_parameter_type(param, "not an object") is not None
    ...
    async def test_parameter_rules_validation(self, template_engine: TemplateEngine):
        ...
        assert template_engine._validate_parameter_rules(param, "way too long string") is not None
        ...
        assert template_engine._validate_parameter_rules(param, [1, 2, 3, 4]) is not None
...
class TestTemplateAPI:
    ...
    async def test_list_templates(self, client: TestClient, auth_headers, db_session: Session):
    ...
    async def test_get_template(self, client: TestClient, auth_headers, db_session: Session):
    ...
    async def test_instantiate_template(self, client: TestClient, auth_headers, db_session: Session, test_user: User):
        """Test instantiating a workflow from a template."""
    ...
    async def test_list_categories(self, client: TestClient, auth_headers, db_session: Session):
        ...
        with patch("app.auth.get_current_user"):
            response = client.get("/api/templates/categories/list", headers=auth_headers)
