...
class TestBillingService:
    ...
    @pytest.mark.asyncio
    async def test_create_subscription_success(self, billing_service, mock_tenant, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_create_subscription_with_trial(self, billing_service, mock_tenant, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_update_subscription_success(self, billing_service, mock_tenant, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_cancel_subscription_success(self, billing_service, mock_tenant, mock_db):
        ...
        with patch('stripe.Subscription.modify') as mock_modify:
            ...
            mock_modify.assert_called_once_with(
                mock_tenant.stripe_subscription_id,
    ...
    async def test_get_usage_summary(self, billing_service, mock_tenant, mock_db):
        ...
        # Mock database queries
        mock_db.query.return_value.filter.return_value.all.return_value = mock_usage_logs
    ...
    @pytest.mark.asyncio
    async def test_handle_stripe_webhook_payment_succeeded(self, billing_service, mock_db):
...
class TestBrandingService:
    ...
    @pytest.mark.asyncio
    async def test_validate_branding_compliance(self, branding_service, mock_tenant, mock_db):
        """Test branding compliance validation."""
        # Mock database queries
        mock_db.query.return_value.filter.return_value.first.return_value = mock_tenant
        
        compliance_report = await branding_service.validate_branding_compliance(mock_tenant.id)
