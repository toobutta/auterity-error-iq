...
class EmailService:
    ...
    def __init__(self):
        ...
        self.default_from_email = getattr(settings, 'DEFAULT_FROM_EMAIL', 'noreply@auterity.com')
        ...
        try:
            ...
            if attachments:
                for attachment_data in attachments:
                    ...
                    attachment.file_type = attachment_data.get('type', 'application/octet-stream')
    ...
    def send_bulk_email(
        ...
        for recipient in recipients:
            ...
            personalized_plain = plain_template.format(**recipient) if plain_template else None
