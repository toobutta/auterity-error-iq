...
from evidently.metrics import DataDriftMetric, DataQualityMetric, RegressionQualityMetric
...
class MLMonitoringService:
    ...
    def __init__(self, service_url: Optional[str] = None):
        ...
        self.service_url = service_url or getattr(settings, 'EVIDENTLY_URL', 'http://evidently:8085')
    ...
    def _extract_performance_metrics(self, report_dict: Dict[str, Any]) -> Dict[str, Any]:
