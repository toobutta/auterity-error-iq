...
class MockSmartTriageService:
    ...
    async def triage_content(self, tenant_id: UUID, content: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    async def create_triage_rule(self, tenant_id: UUID, rule_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def get_triage_accuracy(self, tenant_id: UUID, days: int = 30) -> Dict[str, Any]:
