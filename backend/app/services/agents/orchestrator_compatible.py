...
class AgentOrchestrator:
    ...
    async def execute_workflow(self, workflow_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if workflow_metadata['type'] == 'sequential':
                ...
                raise ValueError(f"Unsupported workflow type: {workflow_metadata['type']}")
    ...
    async def _execute_sequential_workflow(self, steps: List[Dict[str, Any]], execution_id: str) -> List[Dict[str, Any]]:
        ...
        for i, step in enumerate(steps):
            try:
                step_result = await self._execute_agent_step(step, context, execution_id, i)
    ...
    async def _execute_parallel_workflow(self, steps: List[Dict[str, Any]], execution_id: str) -> List[Dict[str, Any]]:
