...
class WorkflowExecutionLogger:
    ...
    def log_step_complete(self, step_name: str, step_type: str, output_data: dict = None, duration_ms: float = None):
    ...
    def log_step_error(self, step_name: str, step_type: str, error: str, duration_ms: float = None):
    ...
    def log_execution_complete(self, output_data: dict = None, duration_ms: float = None):
