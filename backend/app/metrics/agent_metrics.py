...
class AgentMetricsCollector:
    ...
    def record_request(endpoint: str, method: str, status_code: int, duration: float, 
                      agent_type: str = None, tenant_id: str = None):
    ...
    def record_workflow_execution(workflow_id: str, status: str, duration: float,
                                coordination_strategy: str = None, tenant_id: str = None):
    ...
    @staticmethod
    def record_rag_query(domain: str, use_qa: bool, status: str, duration: float,
                        tenant_id: str = None):
    ...
    @staticmethod
    def record_compliance_validation(operation: str, result: str, tenant_id: str = None):
    ...
    def update_service_health(service_name: str, is_healthy: bool):
        ...
        agent_service_health.labels(service_name=service_name).set(1 if is_healthy else 0)
    ...
    @staticmethod
    def record_document_indexing(document_count: int, domain: str, tenant_id: str = None):
