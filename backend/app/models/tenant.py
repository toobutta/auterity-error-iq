...
from sqlalchemy import UUID, Boolean, Column, DateTime, ForeignKey, String, Text, JSON, Integer, Numeric
...
class Tenant(Base):
    ...
    subscription_plan = Column(String(50), default=SubscriptionPlan.STARTER, nullable=False, index=True)
...
class UsageLog(Base):
    ...
    # Usage details
    resource_type = Column(String(50), nullable=False, index=True)  # ai_request, workflow_execution, user_login
    resource_id = Column(String(255), nullable=True, index=True)
