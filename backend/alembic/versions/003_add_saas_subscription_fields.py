...
def upgrade():
    ...
    op.add_column('tenants', sa.Column('subscription_plan', sa.String(50), nullable=True))
    ...
    op.add_column('tenants', sa.Column('current_period_start', sa.DateTime(timezone=True), nullable=True))
    ...
    op.add_column('tenants', sa.Column('max_ai_requests_per_month', sa.Integer(), nullable=True))
    op.add_column('tenants', sa.Column('current_month_ai_requests', sa.Integer(), nullable=True))
    op.add_column('tenants', sa.Column('monthly_budget', sa.Numeric(10, 2), nullable=True))
    ...
    op.add_column('tenants', sa.Column('remove_auterity_branding', sa.Boolean(), nullable=True))
    
    # Add industry profile fields
    op.add_column('tenants', sa.Column('industry_profile', sa.String(50), nullable=True))
    op.add_column('tenants', sa.Column('industry_settings', postgresql.JSON(astext_type=sa.Text()), nullable=True))
    ...
    op.create_index(op.f('ix_billing_records_stripe_invoice_id'), 'billing_records', ['stripe_invoice_id'], unique=False)
    ...
    op.create_index(op.f('ix_tenants_industry_profile'), 'tenants', ['industry_profile'], unique=False)
    op.create_index(op.f('ix_tenants_custom_domain'), 'tenants', ['custom_domain'], unique=False)
