...
def upgrade():
    ...
    op.create_table('triage_rules',
        ...
        sa.Column('rule_type', sa.String(50), nullable=False),  # 'ml', 'rule_based', 'hybrid'
        sa.Column('name', sa.String(255), nullable=False),
        sa.Column('conditions', postgresql.JSONB, nullable=False),
        sa.Column('routing_logic', postgresql.JSONB, nullable=False),
        sa.Column('confidence_threshold', sa.Numeric(3, 2), nullable=False, default=0.8),
    ...
    op.create_table('vector_embeddings',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False, default=uuid.uuid4),
        sa.Column('tenant_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('item_type', sa.String(50), nullable=False),  # 'workflow', 'ticket', 'template'
        sa.Column('item_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('content_hash', sa.String(64), nullable=False),
        sa.Column('embedding_vector', postgresql.JSONB, nullable=False),  # Store as JSON for now, will use pgvector later
    ...
    op.create_table('integrations',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False, default=uuid.uuid4),
        sa.Column('tenant_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('provider', sa.String(100), nullable=False),  # 'slack', 'zendesk', 'salesforce'
        sa.Column('name', sa.String(255), nullable=False),
    ...
    op.create_table('channel_triggers',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False, default=uuid.uuid4),
        sa.Column('tenant_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('channel_type', sa.String(50), nullable=False),  # 'voice', 'sms', 'email', 'webhook'
        sa.Column('name', sa.String(255), nullable=False),
    ...
    op.create_table('custom_models',
        ...
        sa.Column('model_type', sa.String(50), nullable=False),  # 'llm', 'embedding', 'classification'
        sa.Column('config', postgresql.JSONB, nullable=False),
    ...
    op.create_index('idx_triage_rules_tenant_active', 'triage_rules', ['tenant_id', 'is_active'])
    op.create_index('idx_vector_embeddings_tenant_type', 'vector_embeddings', ['tenant_id', 'item_type'])
    op.create_index('idx_integrations_tenant_provider', 'integrations', ['tenant_id', 'provider'])
    op.create_index('idx_channel_triggers_tenant_type', 'channel_triggers', ['tenant_id', 'channel_type'])
    op.create_index('idx_custom_models_tenant_status', 'custom_models', ['tenant_id', 'status'])
    op.create_index('idx_agent_memories_agent_hash', 'agent_memories', ['agent_id', 'context_hash'])
    op.create_index('idx_execution_metrics_execution', 'execution_metrics', ['execution_id'])
    op.create_index('idx_triage_results_tenant_created', 'triage_results', ['tenant_id', 'created_at'])
