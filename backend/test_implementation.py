...
def test_imports():
    ...
    try:
        ...
        from app.models.auterity_expansion import (
            TriageRule, VectorEmbedding, Integration, IntegrationWebhook,
            ChannelTrigger, CustomModel, AgentMemory, ExecutionMetric, TriageResult
        )
        print("✅ Auterity expansion models imported successfully")
        
        # Test schemas
        from app.schemas.auterity_expansion import (
            TriageRuleCreate, TriageRuleResponse, TriageRequest, TriageResponse,
            VectorEmbeddingCreate, SimilaritySearchRequest, IntegrationCreate,
            AgentDeployRequest, LiveInsightsRequest
        )
...
def test_model_instantiation():
    ...
    try:
        from app.models.auterity_expansion import (
            TriageRule, VectorEmbedding, Integration, ChannelTrigger,
            CustomModel, AgentMemory, ExecutionMetric, TriageResult
        )
...
def test_api_endpoints():
    ...
    try:
        ...
        # Show key endpoints
        key_endpoints = [
            "/triage", "/triage/rules", "/triage/accuracy",
            "/similarity/search", "/similarity/embeddings", "/similarity/clusters",
            "/agents/deploy", "/agents/assign", "/agents/memory", "/agents/coordinate"
        ]
...
def test_schema_validation():
    ...
    try:
        from app.schemas.auterity_expansion import (
            TriageRuleCreate, VectorEmbeddingCreate, IntegrationCreate
        )
...
def test_main_app_integration():
    ...
    try:
        ...
        if auterity_routes:
            print(f"✅ Found {len(auterity_routes)} Auterity expansion routes in main app")
        else:
        ...
        print("   This is expected during development and will be resolved in production")
...
def test_frontend_components():
    ...
    try:
        frontend_dir = Path(__file__).parent.parent / "frontend" / "src" / "components" / "auterity-expansion"
