...
async def validate_template_system():
    ...
    try:
        ...
        parameter_values = {"test_param": "Hello, World!"}
        ...
        if len(general_templates) > 0:
            print(
                f"✅ Category filtering working: {len(general_templates)} general templates"
            )
        else:
...
def validate_database_schema():
    ...
    try:
        ...
        print(
            f"✅ Template parameters table accessible, contains {param_count} records"
        )
