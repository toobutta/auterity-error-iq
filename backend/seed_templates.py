    ...
    return {
        ...
        "definition": {
            ...
            "edges": [
                ...
                {"id": "e2", "source": "analyze_inquiry", "target": "generate_response"},
    ...
    return {
        ...
        "definition": {
            ...
            "edges": [
                ...
                {"id": "e2", "source": "extract_details", "target": "check_availability"},
                {"id": "e3", "source": "check_availability", "target": "generate_options"},
