              ...
              <div className="relative flex space-x-3">
                <div>
                  <span className={`h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white ${
                    event.type === 'occurrence' ? 'bg-red-500' :
                ...
                <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                  <div>
                    ...
                    {event.user && (
                      <p className="mt-0.5 text-xs text-gray-500">by {event.user}</p>
                    )}
                  </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-500">
              ...
              <span className={`px-2 py-1 rounded-full text-xs ${
                issue.environment === 'production' ? 'bg-red-100 text-red-700' :
                issue.environment === 'staging' ? 'bg-yellow-100 text-yellow-700' :
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="text-2xl font-bold text-gray-900">{issue.affectedUsers.toLocaleString()}</div>
                    <div className="text-sm text-gray-600">Affected Users</div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="text-2xl font-bold text-gray-900">{issue.occurrenceCount.toLocaleString()}</div>
