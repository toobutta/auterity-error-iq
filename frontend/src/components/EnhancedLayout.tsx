...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const [notifications] = useState([
    ...
    { id: 3, title: 'New template available', message: 'Customer onboarding template has been published', time: '3 hours ago', unread: false },
  ]);
                  ...
                  <div className="absolute right-0 top-full mt-2 w-80 card border shadow-xl z-50" style={{ animation: 'slideInDown 0.2s ease-out' }}>
                    ...
                    <div className="max-h-80 overflow-y-auto">
                      {notifications.map((notification) => (
                        <div key={notification.id} className="p-4 border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                      <button className="btn-primary btn-sm w-full">View all notifications</button>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="relative user-menu">
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 top-full mt-2 w-56 card border shadow-xl z-50" style={{ animation: 'slideInDown 0.2s ease-out' }}>
                    ...
                    <div className="p-2">
                      <Link to="/profile" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                        <Icons.User className="w-4 h-4" />
                        <span className="text-sm">Profile</span>
                      </Link>
                      <Link to="/settings" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
