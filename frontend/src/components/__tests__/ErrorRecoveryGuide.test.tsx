...
describe('ErrorRecoveryGuide', () => {
  ...
  it('displays appropriate recovery steps for workflow errors', () => {
    ...
    expect(screen.getByText('Review Workflow Configuration')).toBeInTheDocument();
  ...
  it('updates progress correctly', () => {
    ...
    expect(screen.getByText(/Progress: 0 of \d+ steps completed/)).toBeInTheDocument();
    ...
    expect(screen.getByText(/Progress: 1 of \d+ steps completed/)).toBeInTheDocument();
  });
